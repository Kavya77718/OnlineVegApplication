...
public class CustomerServiceMockitoTest {
	...
	void testAddCustomer() {
		Customer customer = new Customer("Kavya", "886535214", "abcd@g.com","kavya123");
    ...
    //@Disabled
	void testViewList() {
		Customer customer1 = new Customer("Kavya", "886535214", "abcd@g.com","kavya123");
		Customer customer2 = new Customer("Kavya", "886535214", "abced@g.com","kavya123");
	...
	void testDeleteCustomerbyId() {
		Customer customer = new Customer("tommy", "951771122", "tom@gmail.com", "podcast123");
	...
	void testViewCustomerbyId() {
		Customer customer = new Customer("jen", "951771122", "tom@gmail.com","345ghk");
		Mockito.when(custRep.findById(1)).thenReturn(Optional.of(customer));
	...
	void testUpdateCustomer() {
		Customer customer1 = new Customer("minion", "951771122", "tom@gmail.com", "password");
	...
	void testViewAllCustomers() {
		Customer customer1 = new Customer("son", "951771122", "tom@gmail.com","password");
		Customer customer2 = new Customer("lee", "951998122", "jerry@gmail.com","password");
		List<Customer> customerList = new ArrayList<>();
		customerList.add(customer1);
		customerList.add(customer2);
