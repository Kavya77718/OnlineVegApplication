...
class VegetableServiceMockitoTest {
	...
	void testAdd() {
		Vegetable a = new Vegetable(7, "Cucumber", "Stem", 80, 25,
				"Cucumber has been found to decrease bad cholesterol and blood sugar levels as well.");
	...
	void viewAllVegetables() {
		Vegetable d1 = new Vegetable(1, "Radish", "Root", 10, 5,
				"Radish is also a good source of natural nitrates that improve blood flow.");
		...
		Vegetable d4 = new Vegetable(4, "Lettuse", "Leaves", 55, 5,
				" Lettuce is also a good source of various other health-beneficial bioactive compounds. In vitro and in vivo studies have shown anti-inflammatory, cholesterol-lowering, and anti-diabetic activities attributed to the bioactive compounds in lettuce.");
	...
	void testFindVegetableById() {
		Vegetable r = new Vegetable(6, "Spinach", "Leaves", 10, 2,
				"Spinach gives good eye health, reduce oxidative stress, help prevent cancer, and reduce blood pressure levels.");
