...
public class VegBillController {
	...
	/**
	 * This below function is used to add a new bill and redirects to the Billing
	 * Service
	 */
	...
	public ResponseEntity<BillingDetails> updateBill(@PathVariable("id") int billingId,
			@Valid @RequestBody BillingDetails bill) {
