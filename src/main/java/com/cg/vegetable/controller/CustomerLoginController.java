package com.cg.vegetable.controller;
	...
	import com.cg.vegetable.service.ICustomerLoginService;
	...
	public class CustomerLoginController {
		...
		public ResponseEntity<Customer>  Login(@Valid @RequestBody CustomerLogin loginentity) {
			...
			Customer cust=null;
			if (loginentity.getEmailId()==null || loginentity.getPassword()==null || loginentity.getEmailId().equals("")||loginentity.getPassword().equals("")) {
